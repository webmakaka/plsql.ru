...
Если кому-то интересно, то это фреймворк от Oracle, для создания приложений, работающих с базой данных Oracle и сервером приложений Oracle Weblogic. Язык программирования бизнес логики - java.
